...
* The original package name 'uk.gov.companieshouse.filing-notification-sender-java' is invalid and this project uses 'uk.gov.companieshouse.filing_notification_sender_java' instead.
